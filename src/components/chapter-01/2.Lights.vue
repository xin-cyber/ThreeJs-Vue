...
export default {
    ...
    mounted() {
        ...
        renderer.shadowMap.enabled = true; // 消耗性能，产生阴影
        ...
        cube.castShadow = true; // 发射shadows
        ...
        spotLight.castShadow = true; // dynamic shadows ,默认false，消耗性能

        // SpotLightShadow
        spotLight.shadow.mapSize = new THREE.Vector2(1024, 1024); // default 512 512;width;height;
        spotLight.shadow.camera.far = 130; // default:500
        spotLight.shadow.camera.near = 40; // default:0.5
        ...
        var ambienLight = new THREE.AmbientLight(0x353535); //全局光，无法产生投影，没有方向性
